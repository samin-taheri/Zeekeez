                                                ...
                                                <div id="tshirtaccordion" className="accordion" role="tablist">
                                                    <div>
                                                        ...
                                                        <div className="accordion-collapse collapsed tshirtaccordion" role="tabpanel" data-bs-parent="tshirtaccordion">
                                                            <div className="filtrelekisim">
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-5"/><label className="form-check-label" for="formCheck-5">Rent<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-6"/><label className="form-check-label" for="formCheck-6">Sale<span className="text-muted filter-number">(50)</span></label></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="ceketaccordion" className="accordion" role="tablist">
                                                    <div>
                                                        ...
                                                        <div className="accordion-collapse collapse ceketaccordion" role="tabpanel" data-bs-parent="ceketaccordion">
                                                            <div className="filtrelekisim">
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-7"/><label className="form-check-label" for="formCheck-7">Apartment<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-8"/><label className="form-check-label" for="formCheck-8">Villa<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-2"/><label className="form-check-label" for="formCheck-2">Office<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-1"/><label className="form-check-label" for="formCheck-1">Penthouse<span className="text-muted filter-number">(50)</span></label></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="other-accordion" className="accordion" role="tablist">
                                                    <div>
                                                        ...
                                                        <div className="accordion-collapse collapse other-accordion" role="tabpanel" data-bs-parent="other-accordion">
                                                            <div className="filtrelekisim">
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-3"/><label className="form-check-label" for="formCheck-3">Apartment<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-4"/><label className="form-check-label" for="formCheck-4">Villa<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-9"/><label className="form-check-label" for="formCheck-9">Office<span className="text-muted filter-number">(50)</span></label></div>
                                                                <div className="form-check"><input className="form-check-input" type="checkbox" id="formCheck-10"/><label className="form-check-label" for="formCheck-10">Penthouse<span className="text-muted filter-number">(50)</span></label></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="col-md-10">
                            <div className="mybox p-3">
                                <div className="propertyhead-div">
                                    ...
                                    <div><button className="btn btn-dark mybtn d-flex align-items-center" onClick={routeChange} type="button"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-plus-circle me-3">
                                    ...
                                    <form>
                                        <div className="propertiestable">
                                            ...
                                            <div className="flex-table">
                                                ...
                                                <div className="flex-table-cl"><span className="table-col-mobile-title">Email</span><span><span className="status-name"><span className="status-dot blue"></span>Prospect</span></span></div>
